...
export type GetReleaseByTagQueryVariables = Exact<{
  tagName: Scalars['String'];
}>;


export type GetReleaseByTagQuery = (
  { __typename?: 'Query' }
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & { release?: Maybe<(
